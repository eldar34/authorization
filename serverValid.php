...
if (in_array('error', $status_arr)) {
    ...
    $create = new CreateReport();
    $filePath = $create->addFile($fileTmpPath, $fileName, $fileSize, $fileType);
    $createReacord =  $create->addRecord($name, $surname, $email, $pass, $filePath);
